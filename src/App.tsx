        ...
        <details className="usage">
          ...
          <div className="usage-body">
            <ol>
              ...
              <li><b>進み方</b>を選択: <b>手動</b>／<b>自動送り</b>（終了→間隔で次・無評価は普）／<b>評価するまでループ</b>（評価するまで繰り返し、評価したら止めて即次へ）。無音スキップ・評価フィルタ等は「再生・評価 設定」で（各項目に説明あり）。</li>
              <li><b>作業中モード</b>: ブラウザを非アクティブにすると画面全体でホイール評価でき、オーバーレイで現在の評価・進み方・残り時間を表示（別アプリ作業中の「ながら評価」）。</li>
