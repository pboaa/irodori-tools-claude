...
export function defaultParams(): ParamRange[] {
  return [
    ...
    { flag: 'seed', label: 'seed', type: 'int', kind: 'off', fixed: 0, min: 0, max: 2147483647, decimals: 0, slider: false, sliderMin: 0, sliderMax: 2147483647, step: 1, default: 0 },
    ...
    { flag: 'cfg-scale-text', label: 'cfg-scale-text', type: 'float', kind: 'off', fixed: 3.0, min: 2.0, max: 4.0, decimals: 2, slider: true, sliderMin: 0, sliderMax: 10, step: 0.1, default: 3.0 },
    ...
    { flag: 'cfg-scale-speaker', label: 'cfg-scale-speaker', type: 'float', kind: 'off', fixed: 5.0, min: 4.0, max: 6.0, decimals: 2, slider: true, sliderMin: 0, sliderMax: 10, step: 0.1, default: 5.0 },
